/* =========================================================
   ...
   Loaded as an ES module; the pure computational geometry
   lives in geometry.js (unit-tested via `node --test`).
   ========================================================= */
import {
  CELL_SIZE, FEET_PER_CELL, LINE_WIDTH_FEET,
  computeBBox, fitSimilarity, buildParcelGrid, closestPointOnSegment,
  computeFloodFill
} from "./geometry.js";
...
(function () {
  ...
  /* --- Geometry: parcel polygon → grid projection ---
     geoToLocalMeters / rotatePoints / computeBBox / fitSimilarity / buildParcelGrid /
     computeAutoAlignBearing / closestPointOnSegment all live in geometry.js now
     (pure + unit-tested). computeAutoAlignBearing takes the road direction as a
     parameter — pass selectedParcelRoadDir at the call site. --- */
