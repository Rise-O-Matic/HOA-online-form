...
- Improvements-list ↔ plot cross-check (Sprint 9 v2 nicety): compare the item list against `plotLegend()` and nudge on mismatches ("you painted Concrete on the plan but no improvement item mentions it").
